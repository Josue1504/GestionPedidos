-- Script para PostgreSQL - Base de datos gestion_pedidos en Render
-- Convertido desde MySQL para compatibilidad
...
CREATE TABLE IF NOT EXISTS inventario_productos (
    codigo_producto VARCHAR(50) NOT NULL PRIMARY KEY,
...
WHERE r.name = 'admin'
ON CONFLICT DO NOTHING; -- Admin tiene todos los permisos
...
AND p.name IN ('pedidos.create', 'pedidos.view_own')
ON CONFLICT DO NOTHING; -- Vendedor solo crear y ver propios

-- =======================
-- 5. USUARIO ADMINISTRADOR POR DEFECTO
-- =======================

-- Crear usuario admin por defecto (password: 123)
...
ON CONFLICT (codigo_producto) DO UPDATE SET descripcion = EXCLUDED.descripcion;

-- =======================
-- SCRIPT COMPLETADO
-- =======================
-- Base de datos PostgreSQL lista para Render
-- Contiene:
-- - Estructura completa de tablas (compatible con PostgreSQL)
-- - Sistema de roles y permisos
-- - Usuario admin por defecto (admin/123)
